...
////////////////////////////////////////////////////////////////////////////////
void GameObject::Draw(GraphicsManager& gm)
{
	sprite->Draw(gm);
}
////////////////////////////////////////////////////////////////////////////////
void GameObject::MoveSteps(int x, int y)
{
	Vector2 currentPos = sprite->GetPosition();
	Vector2 newPos = Vector2(currentPos.x + sprite->GetWidth() * x, 
							 currentPos.y + sprite->GetHeight() * y);
